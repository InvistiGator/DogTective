...
public class scene31Manager : MonoBehaviour {
	...
	public audio31Script audioManager;
	...
	void Awake(){
		...
		audioManager = audioManager.GetComponent<audio31Script>();
	}
	void Start () {
	...
	void Update () {
		if(section == 1 && i == dialogue_1Length+1){
			...
			StartCoroutine(sceneManagerScript.FadeStuff(32));
		}
		else if (section == 22 && i == dialogue_2_2Length+1){
			StartCoroutine(sceneManagerScript.FadeStuff(33));
		}
	}
