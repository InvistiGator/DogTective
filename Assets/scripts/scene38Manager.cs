...
public class scene38Manager : MonoBehaviour {
	...
	public audio38Script audioManager;
	...
	void Awake(){
		...
		audioManager = audioManager.GetComponent<audio38Script>();
	}
	void Start () {
		sceneManagerScript.setUserVisited(38);
		sceneManagerScript.printCurrentKillerID();
		
		dialogue_1 = sceneManagerScript.readFile("Scene38_1.txt");
		emotion_1 = sceneManagerScript.readEmotion("38_1.txt");
		dialogue_1Length = dialogue_1.Length;

		dialogue_2 = sceneManagerScript.readFile("Scene38_2.txt");
		emotion_2 = sceneManagerScript.readEmotion("38_2.txt");
		dialogue_2Length = dialogue_2.Length;

		dialogue_3 = sceneManagerScript.readFile("Scene38_3.txt");
		emotion_3 = sceneManagerScript.readEmotion("38_3.txt");
		dialogue_3Length = dialogue_3.Length;

		dialogue_4 = sceneManagerScript.readFile("Scene38_4.txt");
		emotion_4 = sceneManagerScript.readEmotion("38_4.txt");
